...
Установки производятся на Deian 10
...
apt-get install docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin -y  #Установка всего необходимо из ранее добавленного репозитория докер
...
После произведенных установок пришло время написать свой первый DockerFile и Pipeline для него
